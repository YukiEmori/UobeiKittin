...
namespace UobeiKittin {
    ...
    public partial class SushiOrderDBDataSet : global::System.Data.DataSet {
        ...
        public partial class testDataTable : global::System.Data.TypedTableBase<testRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public testRow AddtestRow(string Picture, int ID) {
        ...
        public partial class testRow : global::System.Data.DataRow {
            ...
            public string Picture {
                get {
                    try {
                        return ((string)(this[this.tabletest.PictureColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("テーブル \'test\' にある列 \'Picture\' の値は DBNull です。", e);
                    }
                }
                set {
                    this[this.tabletest.PictureColumn] = value;
                }
            }
            ...
            public bool IsPictureNull() {
                return this.IsNull(this.tabletest.PictureColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetPictureNull() {
                this[this.tabletest.PictureColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace UobeiKittin.SushiOrderDBDataSetTableAdapters {
    ...
    public partial class testTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[test] WHERE (((@IsNull_Picture = 1 AND [Picture] IS NULL) OR (" +
                "[Picture] = @Original_Picture)) AND ([ID] = @Original_ID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[test] ([Picture], [ID]) VALUES (@Picture, @ID);\r\nSELECT Pictur" +
                "e, ID FROM test WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[test] SET [Picture] = @Picture, [ID] = @ID WHERE (((@IsNull_Picture" +
                " = 1 AND [Picture] IS NULL) OR ([Picture] = @Original_Picture)) AND ([ID] = @Ori" +
                "ginal_ID));\r\nSELECT Picture, ID FROM test WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Picture, ID FROM dbo.test";
        ...
        public virtual int Fill(SushiOrderDBDataSet.testDataTable dataTable) {
        ...
        public virtual SushiOrderDBDataSet.testDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SushiOrderDBDataSet.testDataTable dataTable = new SushiOrderDBDataSet.testDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SushiOrderDBDataSet.testDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Picture, int Original_ID) {
        ...
        public virtual int Insert(string Picture, int ID) {
            if ((Picture == null)) {
        ...
        public virtual int Update(string Picture, int ID, string Original_Picture, int Original_ID) {
            if ((Picture == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Picture, string Original_Picture, int Original_ID) {
            return this.Update(Picture, Original_ID, Original_Picture, Original_ID);
        }
    }
